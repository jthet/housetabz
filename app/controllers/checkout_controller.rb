class CheckoutController < ApplicationController
  def create_checkout_session
    ...
    cancel_url = 'https://3fb4-50-26-12-91.ngrok-free.app/checkout'  # Replace with your cancel URL
    success_url = "https://3fb4-50-26-12-91.ngrok-free.app/checkout_success?user_id=#{user_id}&price=#{custom_price}"
